...
initData=struct('pCur',pCur(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),'pGt',pGt(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),'pGtN',pGtN(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),'pStar',pStar(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),...
    'imgIds',imgIds,'N',N,'N1',N1);
...
[regModel,~] = rcprTrain(IsTr,phisTr(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),trPrm);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TEST
%Initialize randomly using RT1 shapes drawn from training
%p=shapeGt('initTest',IsT,bboxesT,model,pStar(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),pGtN(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]),RT1);
load 'pRT.mat'
p=pRT(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75],:);%改增
%Create test struct
...
%Compute loss
loss = shapeGt('dist',regModel.model,p,phisT(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]));
fprintf('--------------DONE\n');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tzy=phisT(:,[1 3 5 6 9 11 13 14 17 30 32 34 35 38 40 42 43 46 59 61 63 64 67 69 71 72 75]);
