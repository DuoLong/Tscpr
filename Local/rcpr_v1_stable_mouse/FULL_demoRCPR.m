...
initData=struct('pCur',pCur(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),'pGt',pGt(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),'pGtN',pGtN(:, [23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),'pStar',pStar(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),...
    'imgIds',imgIds,'N',N,'N1',N1);
%Create training structure
%下面一行新添加
model.D=21;   %自己加
model.nfids=7;   %自己加
regPrm.model.D=21;% 自己加
regPrm.model.nfids=7; %自己加
...
trPrm.regPrm.model.D=21;   %自加，前面已改可有可无
trPrm.regPrm.model.nfids=7;  %自加，前面已改可有可无
[regModel,~] = rcprTrain(IsTr,phisTr(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),trPrm);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TEST
%Initialize randomly using RT1 shapes drawn from training
%p=shapeGt('initTest',IsT,bboxesT,model,pStar(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),pGtN(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]),RT1);
load 'pRT.mat'
p=pRT(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87],:);%改增
%Create test struct
regPrm.model.D=21;% 自己加，上面已改。
regPrm.model.nfids=7; %自己加，上面已改。
...
%Compute loss
% loss = shapeGt('dist',regModel.model,p,phisT(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]));
% fprintf('--------------DONE\n');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tzy=phisT(:,[23 24 25 26 27 28 29 52 53 54 55 56 57 58 81 82 83 84 85 86 87]);
